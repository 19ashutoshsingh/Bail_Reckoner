...
import '../App.css'; // Import your CSS styles
import Icon_Balance from '../assets/Images/Icon_balance_scale.png';
import NewCaseModal from './NewCaseModal'; // Import the modal component
...
function LegalAidDashboard() {
  ...
  return (
    <div className="LegalAidDashboard">
      ...
      {/* Button to open the New Case modal */}
      <button className="new-case-button" onClick={openModal}>New Case</button>
      ...
      {/* Modal component */}
      <NewCaseModal isOpen={isModalOpen} onClose={closeModal} />
    </div>
  );
}
